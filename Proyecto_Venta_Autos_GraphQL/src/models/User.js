...
const userSchema = new mongoose.Schema({
    name: {
        ...
        trim: true // Borra los espacios en blanco al inicio y al final si el usuario si se equivoca
    },
    email: {
        type: String,
        required: true,
...
userSchema.pre('save', async function(){//(next) {
    // Si la contraseña no se está modificando o creando, continuamos sin hacer nada
